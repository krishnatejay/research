...
def startSetup():
    ...
    bd1.cmd('sudo python  customServer.py >> botdLogs.txt &')
    bd2.cmd('sudo python  customServer.py >> botdLogs.txt &')
    bd3.cmd('sudo python  customServer.py >> botdLogs.txt &')
    bd4.cmd('sudo python  customServer.py >> botdLogs.txt &')
    bd5.cmd('sudo python  customServer.py >> botdLogs.txt &')
    bd6.cmd('sudo python  customServer.py >> botdLogs.txt &')
    bd7.cmd('sudo python  customServer.py >> botdLogs.txt &')
    bd8.cmd('sudo python  customServer.py >> botdLogs.txt &')
    bd9.cmd('sudo python  customServer.py >> botdLogs.txt &')
    bd10.cmd('sudo python  customServer.py >> botdLogs.txt &')
    bd11.cmd('sudo python  customServer.py >> botdLogs.txt &')
    bd12.cmd('sudo python  customServer.py >> botdLogs.txt &')
    bd13.cmd('sudo python  customServer.py >> botdLogs.txt &')
...
subprocess.call("rm -rf /home/ubuntu/research/ipStats.txt",  shell=True)

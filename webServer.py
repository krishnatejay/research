...
def outputStats():
	...
	while(True):
		...
		if(currentMinute-1 in requestStats.keys()):
			...
			a =  "W : " + str(value) + " Minute : " + str(currentMinute -1 ) + " Request Count : " + str(total) + " Success Count : " +  str(requests) + " Dropped : " + str(dropped)
...
class S(BaseHTTPRequestHandler):
	...
	if(requestStats[currentMinute]['requests'] > 30):
